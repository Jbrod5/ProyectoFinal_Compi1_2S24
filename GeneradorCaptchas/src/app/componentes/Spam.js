...
export class Spam extends Componente{
    ...
    establecerParametro(parametro, valor){
        switch(parametro){
            ...
            case 'ID':
                ...
                break;
            default:
                var mensaje = "Error Semantico: se intentó establecer el parametro " + parametro + " en una instancia Spam pero no es un parametro valido para el componente.";
                super.lanzarExcepcionSemantica(mensaje);
        }
    }
    ...
    obtenerCodigo(){
        ...
        var codigo = "<p><span style=\"color: " + this.color + "; font-size: " +  this.fontSize + "; font-family: " + this.fontFamily + "; text-align: " + this.textAlign + ";\">" + this.valor + "</span></p>";
        return codigo; 
    }
