...
export class P extends Componente{
    ...
    establecerParametro(parametro, valor){
        switch(parametro){
            ...
            case 'ID':
                ...
                break;
            default: 
                var mensaje = "Error Semantico: se intentó establecer el parametro " + parametro + " en una instancia P pero no es un parametro valido para el componente.";
                super.lanzarExcepcionSemantica(mensaje);
        }
    }
    ...
    obtenerCodigo(){
        ...
        var codigo = "<p id=\"" + this.id + "\" " + style +">" + this.valor + "</p>\n";
        return codigo; 
    }
}